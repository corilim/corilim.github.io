...
this.wordle.bundle = function(e) {
  ...
  var v = function(e) {
      ...
      function t() {
          var e;
          return check_isinstance(this, t), n(p(e = a.call(this)), "_letter", ""), n(p(e), "_state", "empty"), n(p(e), "_animation", "idle"), n(p(e), "_last", false), n(p(e), "_reveal", false), e.attachShadow({
              mode: "open"
          }), e
      }
      return o(t, [{
  ...
  var x = function(e) {
      ...
      function t() {
          var e;
          return check_isinstance(this, t), (e = a.call(this)).attachShadow({
              mode: "open"
  ...
  var j = "darkTheme",
      ...
      _ = function(e) {
          ...
          function t() {
              var e;
              check_isinstance(this, t), n(p(e = a.call(this)), "isDarkTheme", false), n(p(e), "isColorBlindTheme", false), e.attachShadow({
                  mode: "open"
              });
  ...
  function D(e) {
      return null == e ? undefined === e ? "[object Undefined]" : "[object Null]" : N && N in Object(e) ? function(e) {
          var a = R.call(e, $),
              s = e[$];
          try {
              e[$] = undefined;
  ...
  var me, he = function(e, a, s) {
      ...
      ye = "object" == (undefined === e ? "undefined" : a(e)) && e && !e.nodeType && e,
  ...
  var Je = "object" == (undefined === e ? "undefined" : a(e)) && e && !e.nodeType && e,
  ...
  function aa(e, a, s) {
      var t = e[a];
      ea.call(e, a) && q(t, s) && (undefined !== s || a in e) || ce(e, a, s)
  }
  var sa = /^(?:0|[1-9]\d*)$/;
  ...
  function ua(e, a, s, t, o, n, r) {
      ...
      if (d) pe(e, s, d);
          ...
          var u, c = n ? n(i, l, s + "", e, a, r) : undefined,
              p = undefined === c;
          if (p) {
              var m = Me(l),
                  h = !m && Ne(l),
              ...
              c = l, m || h || y ? Me(i) ? c = i : Ee(u = i) && Re(u) ? c = function(e, a) {
                  ...
                  if (!Ee(e) || "[object Object]" != D(e)) return false;
                  var a = Se(e);
  ...
  function ca(e, a, s, t, o) {
      e !== a && he(a, (function(n, r) {
          if (o || (o = new de), G(n)) ua(e, a, r, s, ca, t, o);
              ...
              var i = t ? t(Ze(e, r), n, r + "", e, a, o) : undefined;
  ...
  var ka, va = (ka = function(e, a, s) {
          ...
          var t = -1,
              ...
              r = o > 2 ? s[2] : undefined;
          for (n = ka.length > 3 && "function" == typeof n ? (o--, n) : undefined, r && function(e, s, t) {
                  if (!G(t)) return false;
                  var o = a(s);
  ...
  var _a = function(e) {
      ...
      function t() {
          var e;
          return check_isinstance(this, t), n(p(e = a.call(this)), "gameApp", undefined), e.attachShadow({
              mode: "open"
          }), e
      }
      return o(t, [{
          ...
          value: function() {
              var e, a = this;
              this.shadowRoot.appendChild(Sa.content.cloneNode(true)), this.shadowRoot.querySelector("#hash").textContent = null === (e = window.wordle) || undefined === e ? undefined : e.hash, this.shadowRoot.querySelector("#puzzle-number").textContent = "#".concat(this.gameApp.dayOffset), this.shadowRoot.addEventListener("game-switch-change", (function(e) {
                  e.stopPropagation();
                  var s = e.detail,
                      t = s.name,
                      o = s.checked,
  ...
  var Ea, Aa = function(e) {
      ...
      function t() {
          var e;
          return check_isinstance(this, t), n(p(e = a.call(this)), "_duration", undefined), e.attachShadow({
              mode: "open"
          }), e
      }
      return o(t, [{
          ...
          if (a[t])
              for (var o = 0; o < e.length; o++) {
                  var n = e[o],
                      r = a[t][o],
                      i = s[n] || "unknown";
                  letter_guess_state[r] > letter_guess_state[i] && (s[n] = r)
              }
      })), s
  }

  function number_noun(e) {
      var a = ["th", "st", "nd", "rd"],
          s = e % 100;
  ...
  function time_difference_in_days(e, a) {
      var s = new Date(e),
          t = new Date(a).setHours(0, 0, 0, 0) - s.setHours(0, 0, 0, 0);
      return Math.round(t / 864e5)
  }

  function solution_index(e) {
      var a, s = days_since_start_date(e);
      return a = s % solution_words.length, solution_words[a]
  }

  function days_since_start_date(e) {
      return time_difference_in_days(start_date, e)
  }
  ...
  var game_in_progress = "IN_PROGRESS",
      game_win = "WIN",
      game_fail = "FAIL",
      completed_exclaim = ["Genius", "Magnificent", "Impressive", "Splendid", "Great", "Phew"],
      ts = function(e) {
          r(t, e);
          var a = h(t);
          ...
          function t() {
              var e;
              check_isinstance(this, t), n(p(e = a.call(this)), "tileIndex", 0), n(p(e), "rowIndex", 0), n(p(e), "solution", undefined), n(p(e), "boardState", undefined), n(p(e), "evaluations", undefined), n(p(e), "canInput", true), n(p(e), "gameStatus", game_in_progress), n(p(e), "letterEvaluations", {}), n(p(e), "$board", undefined), n(p(e), "$keyboard", undefined), n(p(e), "$game", undefined), n(p(e), "today", undefined), n(p(e), "lastPlayedTs", undefined), n(p(e), "lastCompletedTs", undefined), n(p(e), "hardMode", undefined), n(p(e), "dayOffset", undefined), e.attachShadow({
                  mode: "open"
              }), e.today = new Date;
              var o = za();
              return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || time_difference_in_days(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(6).fill(""), e.evaluations = new Array(6).fill(null), e.solution = solution_index(e.today), e.dayOffset = days_since_start_date(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = false, ja({
                  rowIndex: e.rowIndex,
                  boardState: e.boardState,
                  evaluations: e.evaluations,
                  solution: e.solution,
                  gameStatus: e.gameStatus
              }), store("event", "level_start", {
                  level_name: Wa(e.solution)
              })) : (e.boardState = o.boardState, e.evaluations = o.evaluations, e.rowIndex = o.rowIndex, e.solution = o.solution, e.dayOffset = days_since_start_date(e.today), e.letterEvaluations = Pa(e.boardState, e.evaluations), e.gameStatus = o.gameStatus, e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.gameStatus !== game_in_progress && (e.canInput = false), e.restoringFromLocalStorage = true), e
          }
          return o(t, [{
              key: "evaluateRow",
              value: function() {
                  if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                      ...
                      if (e = s, !accepted_words.includes(e) && !solution_words.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Not in word list");
                      if (this.hardMode) {
                          var t = function(e, a, s) {
                                  ...
                                  for (var t = 0; t < s.length; t++)
                                      if (s[t] === Ma && e[t] !== a[t]) return {
                                          validGuess: false,
                                          errorMessage: "".concat(number_noun(t + 1), " letter must be ").concat(a[t].toUpperCase())
                                      };
                      ...
                      if (i || l) Va({
                          isWin: l,
                          isStreak: !!this.lastCompletedTs && 1 === time_difference_in_days(new Date(this.lastCompletedTs), new Date),
                          numGuesses: this.rowIndex
                      }), ja({
                          lastCompletedTs: Date.now()
                      }), this.gameStatus = l ? game_win : game_fail, store("event", "level_end", {
                          level_name: Wa(this.solution),
                          num_guesses: this.rowIndex,
                          success: l
                      });
                      this.tileIndex = 0, this.canInput = false, ja({
              ...
              key: "addLetter",
              value: function(e) {
                  this.gameStatus === game_in_progress && (this.canInput && (this.tileIndex >= 5 || (this.boardState[this.rowIndex] += e, this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("letters", this.boardState[this.rowIndex]), this.tileIndex += 1)))
              }
          }, {
              key: "removeLetter",
              value: function() {
                  if (this.gameStatus === game_in_progress && this.canInput && !(this.tileIndex <= 0)) {
              ...
              key: "submitGuess",
              value: function() {
                  if (this.gameStatus === game_in_progress && this.canInput) {
              ...
              value: function() {
                  ...
                  this.gameStatus === game_win && this.rowIndex <= 6 && a.setAttribute("highlight-guess", this.rowIndex), a.gameApp = this, e.appendChild(a), e.setAttribute("open", "")
              }
          }, {
              key: "showHelpModal",
              value: function() {
              ...
              value: function() {
                  ...
                  this.$game.addEventListener("game-key-press", (function(a) {
                      ...
                      (a.path || a.composedPath && a.composedPath()).includes(s) && ([game_win, game_fail].includes(e.gameStatus) && (e.restoringFromLocalStorage ? e.showStatsModal() : (e.gameStatus === game_win && (s.setAttribute("win", ""), e.addToast(completed_exclaim[e.rowIndex - 1], 2e3)), e.gameStatus === game_fail && e.addToast(e.solution.toUpperCase(), 1 / 0), setTimeout((function() {
                          e.showStatsModal()
  ...
  var keyboard = [
      ...
      us = function(e) {
          ...
          function t() {
              var e;
              return check_isinstance(this, t), n(p(e = a.call(this)), "_letterEvaluations", {}), e.attachShadow({
                  mode: "open"
              }), e
          }
          return o(t, [{
  ...
  var ms, hs, ys, gs, bs = "undefined" == typeof navigator ? undefined : navigator,
      fs = null == bs ? undefined : bs.clipboard;
  null === (ms = null == fs ? undefined : fs.read) || undefined === ms || ms.bind(fs), null === (hs = null == fs ? undefined : fs.readText) || undefined === hs || hs.bind(fs);
  var ks = (null === (ys = null == fs ? undefined : fs.write) || undefined === ys || ys.bind(fs), null === (gs = null == fs ? undefined : fs.writeText) || undefined === gs ? undefined : gs.bind(fs)),
  ...
  var Ms = {
      ...
      Os = function(e) {
          ...
          function t() {
              var e;
              return check_isinstance(this, t), n(p(e = a.call(this)), "stats", {}), n(p(e), "gameApp", undefined), e.attachShadow({
                  mode: "open"
              }), e.stats = Xa(), e
          }
          return o(t, [{
              ...
              value: function() {
                  ...
                  if (["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach((function(s) {
                      ...
                      })), this.gameApp.gameStatus !== game_in_progress) {
                      ...
                      p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                          ...
                          As(function(e) {
                              ...
                              isWin: e.gameApp.gameStatus === game_win
                          }), (function() {
  ...
  var Ys = 6e4,
      ...
      Us = function(e) {
          ...
          function t() {
              var e;
              check_isinstance(this, t), n(p(e = a.call(this)), "targetEpochMS", undefined), n(p(e), "intervalId", undefined), n(p(e), "$timer", undefined), e.attachShadow({
                  mode: "open"
              });
              var o = new Date;
